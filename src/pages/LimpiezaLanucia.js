            ...
            <div className="legal-page">
                <div className="legal-container">
                    <img
                        ...
                        alt="Limpieza de viviendas y apartamentos turísticos en La Nucia"
                        className="seo-hero"
                    />

                    <h1>
                        Limpieza de viviendas y apartamentos turísticos en La Nucia
                    </h1>

                    <p>
                        En <strong>Limpiezas Costa Blanca</strong> ofrecemos
                        servicios profesionales de limpieza en La Nucia para
                        viviendas particulares, apartamentos turísticos,
                        alquileres vacacionales y propiedades de corta estancia.
                    </p>

                    <h2>Servicios disponibles en La Nucia</h2>
                    ...
                    <p>
                        ...
                        vacacionales en toda la zona de La Nucia.
                    </p>
...
export default LimpiezaLanucia;